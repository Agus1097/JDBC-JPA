...
public class Familia {
    ...
    public Familia(int id_familia, String nombre, int edad_minima, int edad_maxima, int num_hijos, String email, Casa id_casa_familia) {
    ...
    public Casa getId_casa_familia() {
        return id_casa_familia;
    }

    public void setId_casa_familia(Casa id_casa_familia) {
        this.id_casa_familia = id_casa_familia;
    }

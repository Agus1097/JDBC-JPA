...
public class Casa {
    ...
    private int casas_por_paias;

    public Casa() {
    }

    public Casa(int id_casa, String calle, int numero, String codigo_postal, String ciudad, String pais, Date fecha_desde, Date fecha_hasta, int tiempo_minimo, int tiempo_maximo, double precio_habitacion, String tipo_vivienda, int casas_por_paias) {
        ...
        this.casas_por_paias = casas_por_paias;
    }
    ...
    public int getCasas_por_paias() {
        return casas_por_paias;
    }

    public void setCasas_por_paias(int casas_por_paias) {
        this.casas_por_paias = casas_por_paias;
    }
